...
from donor_reporting_portal.api.filters import DonorFilter, ExternalGrantFilter, GrantFilter, ThemeFilter
...
class AllowedDonorMixin:
    ...
    def get_queryset(self):
        ...
        return self.model.objects.filter(donor_id=donor_id)
