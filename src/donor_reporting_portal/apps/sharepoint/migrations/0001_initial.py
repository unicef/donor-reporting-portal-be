    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField()),
                ('wrapper_name', models.CharField(max_length=16, unique=True, verbose_name='Wrapper')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='libraries', to='sharepoint.SharePointSite')),
            ],
            options={
